    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('team_club_state') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $team->team_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $team->team_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $team->team_id], ['confirm' => __('Are you sure you want to delete # {0}?', $team->team_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
