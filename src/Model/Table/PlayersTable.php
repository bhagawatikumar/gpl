...
class PlayersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('player_name')
            ->maxLength('player_name', 250)
            ->requirePresence('player_name', 'create')
            ->notEmpty('player_name');

        $validator
            ->scalar('player_image')
            ->maxLength('player_image', 100)
            ->requirePresence('player_image', 'create')
            ->notEmpty('player_image');

        $validator
            ->integer('player_jersey_number')
            ->requirePresence('player_jersey_number', 'create')
            ->notEmpty('player_jersey_number');
    ...
    {
        $rules->add($rules->existsIn(['player_country_id'], 'Countries'));
